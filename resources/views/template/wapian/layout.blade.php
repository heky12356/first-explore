...
<div class="tabbar visible-xs">
   ...
   <br>Copyright:<a href="#" target="_blank">{{config('webset.webicp')}}-{{config('webset.copyright')}}</a><br>{!! config('webset.webtongji') !!}</p>
...
<textarea class="form-control" name="js" id="message-text"></textarea>
              ...
              <div class="form-group">
            <label for="message-text" class="control-label" style="color:#000"><p>验证码:            <img id="captcha_img" border='1' src='http://{{config("webset.webdomin")}}/yanzheng.php?r=echo rand(); ?>' style="width:100px; height:30px" />
    <a href="#" onclick="document.getElementById('captcha_img').src='http://{{config('webset.webdomin')}}/yanzheng.php?r='+Math.random()" style="color:#ff0000">换一个?</a>
  </p></label>             
