      ...
      <div class="col-lg-wide-75 col-xs-1 padding-0">
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
         ...
         <h3 class="title"><img src="/public/static/QZHIJIA/icon/icon_1.png" />好片推荐</h3>
        </div>
       </div>
       <div class="stui-pannel_bd clearfix">
        <ul class="stui-vodlist clearfix">
			...
			<span class="play hidden-xs"></span><span class="pic-text text-right">好片推荐</span></a>           
      ...
      <div class="col-lg-wide-75 col-xs-1 padding-0">
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
         ...
         <h3 class="title"><img src="/public/static/QZHIJIA/icon/icon_1.png" />抢先看</h3>
      ...
      <div class="col-lg-wide-75 col-xs-1 padding-0">
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
         ...
         <h3 class="title"><img src="/public/static/QZHIJIA/icon/icon_2.png" />综艺</h3>
      ...
      <div class="col-lg-wide-75 col-xs-1 padding-0">
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
         ...
         <h3 class="title"><img src="/public/static/QZHIJIA/icon/icon_2.png" />动漫</h3>
